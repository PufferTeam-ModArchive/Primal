...
public class BlockMetaFalling extends BlockFalling implements IPrimalBlock, IMetaBlock {
    ...
    public BlockMetaFalling(Material material, String[] materials, String type, String[] blacklist, String[] tools,
        int[] levels) {
        super(material);
        elements = materials;
        name = type;
    ...
    public BlockMetaFalling(Material material, String[] materials, String type) {
        this(material, materials, type, Constants.none, null, null);
    }

    public BlockMetaFalling setTextureOverride(String[] elementsTextures) {
        this.elementsTextures = elementsTextures;
        return this;
    }

    public BlockMetaFalling setBlacklist(String[] blacklist) {
        this.elementsBlacklist = blacklist;
        return this;
    }

    public BlockMetaFalling setHasSuffix() {
        this.hasSuffix = true;
        return this;
    }

    public BlockMetaFalling setItemTexture() {
