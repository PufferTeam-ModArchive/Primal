...
import net.pufferlab.primal.blocks.BlockCutButton;
...
public class ItemBlockCutButton extends ItemBlock implements IMetaItem, IPrimalItem {

    public ItemBlockCutButton(Block block) {
        super(block);
    ...
    public String getUnlocalizedName(ItemStack stack) {
        if (field_150939_a instanceof BlockCutButton block2) {
