...
import net.pufferlab.primal.blocks.BlockCutPressurePlate;
...
public class ItemBlockCutPressurePlate extends ItemBlock implements IMetaItem, IPrimalItem {

    public ItemBlockCutPressurePlate(Block block) {
        super(block);
    ...
    public String getUnlocalizedName(ItemStack stack) {
        if (field_150939_a instanceof BlockCutPressurePlate block2) {
